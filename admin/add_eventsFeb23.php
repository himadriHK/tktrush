...
$insertSQL = sprintf("INSERT INTO events (promoter, country, title, `desc`, thumb, pic, date_start, date_end, venue, dress, age_limit, restaurant, rest_room, hot, loc_map, floorplan, ongoing, session_hour, doors_open, sale_date,time_start,time_end) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)",
...
?>
 ...
 HH:MM 
				...
				<tr valign="baseline">
                  ...
                  <td bgcolor="#EAEAFF"><input type="text" name="time_end" id="time_end" value="" size="32" class="formField" > HH:MM 
