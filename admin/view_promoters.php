...
if ((isset($_GET['proid'])) && ($_GET['proid'] != "")) {
  $deleteSQL = sprintf("DELETE FROM promoters WHERE spid=%s",
...
mysql_select_db($database_eventscon, $eventscon);
$query_proupdateRs = "SELECT spid, name, `desc`, phone, fax, email, website FROM promoters ORDER BY name ASC";
...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    ...
    <td valign="top"><table width="100%" border="0" cellspacing="1" cellpadding="0">
      <tr>
        <td height="35" bgcolor="#C31600"><span class="eventHeader"><span class="headeradmin">-</span>VIEW PROMOTERS</span></td>
      </tr>
      <tr>
      ...
      <table width="100%" border="0" cellpadding="0" cellspacing="0">
        <tr>
          <td valign="top"><table width="100%" border="0" cellspacing="1" cellpadding="0">
                  <tr>
                    <td height="25" bgcolor="#999999" class="eventVenue"><div align="center">Promoters</div></td>
              ...
              <?php do { ?>
                <tr<?php if ($a==1) {echo ' bgcolor="#CCCCCC"'; $a=0;}else { $a=1;} ?>>
                  ...
                  <td width="50" align="center"><a href="manage_promoters.php?proid=<?php echo $row_proupdateRs['spid']; ?>" class="headeradmin">Edit</a></td>
                  <td width="50" align="center"><a href="view_promoters.php?proid=<?php echo $row_proupdateRs['spid']; ?>" onclick="return confirm('Are you sure you want to delete?')" class="headeradmin">Delete</a></td>
                </tr>
