...
$eventdesc = str_replace("\n", "<br>", $_POST['desc']);
  ...
  $updateSQL = sprintf("UPDATE events SET title=%s, `desc`=%s, thumb=%s, pic=%s, date_start=%s, date_end=%s, venue=%s, dress=%s, age_limit=%s, restaurant=%s, rest_room=%s, hot=%s, country=%s, promoter=%s, loc_map=%s, floorplan=%s, ongoing=%s, session_hour=%s, doors_open=%s, sale_date=%s, time_start=%s, time_end= %s WHERE tid=%s",
...
?>
 ...
 HH:MM 
				...
				<tr valign="baseline">
                  ...
                  <td bgcolor="#EAEAFF"><input type="text" name="time_end" id="time_end" value="<?php echo $row_eventsRs['time_end']; ?>" size="32" class="formField" > HH:MM 
