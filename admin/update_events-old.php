...
$eventdesc = str_replace("\n", "<br>", $_POST['desc']);
  $updateSQL = sprintf("UPDATE events SET title=%s, `desc`=%s, thumb=%s, pic=%s, date_start=%s, date_end=%s, venue=%s, dress=%s, age_limit=%s, restaurant=%s, rest_room=%s, hot=%s, country=%s, promoter=%s, loc_map=%s, floorplan=%s, ongoing=%s, session_hour=%s, doors_open=%s, sale_date=%s WHERE tid=%s",
...
?>
                ...
                <tr valign="baseline">
                  <td align="right" nowrap bgcolor="#DFFF95">Ongoing:</td>
                  <td bgcolor="#EAFFB7"><input type="checkbox" name="ongoing" value="Yes"  <?php if (!(strcmp($row_eventsRs['ongoing'],"Yes"))) {echo "checked=\"checked\"";} ?>></td>
                </tr>
                <tr valign="baseline">
