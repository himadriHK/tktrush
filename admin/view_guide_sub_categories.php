...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO guide_sub_cat (name) VALUES (%s)",
...
if ((isset($_GET['subcatid'])) && ($_GET['subcatid'] != "")) {
  $deleteSQL = sprintf("DELETE FROM guide_sub_cat WHERE catid=%s",
                       GetSQLValueString($_GET['subcatid'], "int"));
...
mysql_select_db($database_eventscon, $eventscon);
$query_categoryRs = "SELECT * FROM guide_sub_cat ORDER BY name ASC";
        ...
        <tr>
          <td valign="top"><table width="100%" border="0" cellspacing="1" cellpadding="0">
            ...
            <?php if($totalRows_categoryRs>0){ do { ?>
              <tr>
                <td bgcolor="#E9E9E9"><a href="manage_guide_sub_categories.php?subcatid=<?php echo $row_categoryRs['subcatid']; ?>" class="eventText"><?php echo $row_categoryRs['name']; ?></a></td>
                <td width="60" bgcolor="#E9E9E9"><div align="center"><a href="manage_guide_sub_categories.php?subcatid=<?php echo $row_categoryRs['subcatid']; ?>" class="headeradmin">Edit</a></div></td>
                <td width="60" bgcolor="#E9E9E9"><div align="center"><a href="view_guide_sub_categories.php?subcatid=<?php echo $row_categoryRs['subcatid']; ?>" onclick="return confirm('Are you sure you want to delete?')" class="headeradmin">Delete</a></div></td>
              </tr>
