...
event_pic1, event_pic2, event_pic3, event_pic4, event_pic5,commission,dtcm,credit_charge,service_charge,partner_commission,dtcm_approved,dtcm_code,fb_link,payment_option,voucher_advert1,voucher_advert2,partner)
VALUES 
(%s,%s, %s, %s, %s,%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, '".$videoName."', '".$audioName."',
'".$category_id."',%s,%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s,%s,%s,%s,%s,%s,%s,%s,%s)",
...
//code to fetch partners
$query_partnersRs = "SELECT DISTINCT spid, name FROM partners ORDER BY name ASC";
...
<tr valign="baseline">
    <td align="right" nowrap bgcolor="#CCCCCC">Partners:</td>
    <td bgcolor="#EAEAFF"><select name="partner" class="formField" style="width:150px">
            <?php
            while ($row_partnerRs = mysql_fetch_assoc($partnersRs)) {
                ?>
                <option value="<?php echo $row_partnerRs['spid']?>" ><?php echo $row_partnerRs['name']?></option>
            <?php
            };
            ?>
        </select>
...
<a href="administer/data/<?php echo (isset($row_eventsRs['pic']))?$row_eventsRs['pic']:''; ?>" target="_blank"></a></td>
</tr>
<tr valign="baseline">
...
<a href="administer/data/<?php echo (isset($row_eventsRs['popup_pic']))?$row_eventsRs['popup_pic']:''; ?>" target="_blank"></a></td>
</tr>
<tr valign="baseline">
...
<a href="administer/data/<?php echo (isset($row_eventsRs['pic']))?$row_eventsRs['pic']:''; ?>" target="_blank"></a> <a href="administer/data/<?php (isset($row_eventsRs['pic']))?$row_eventsRs['pic']:''; ?>" target="_blank"></a></td>
</tr>
<tr valign="baseline">
