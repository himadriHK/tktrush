...
if($yes)
{
	...
	$query = "Delete from tblphotocategory where catid=$del";
	mysql_query($query);
}
...
if($update)
{
	...
	if($userfile=="none")
		{
			$query_up = "UPDATE tblphotocategory SET category='$category',image='$image' where catid=$catid";
		...
		{			
			...
			$query_up = "UPDATE tblphotocategory SET category='$category',image='$userfile_name' where catid=$catid";
			mysql_query($query_up);
...
?>
        <tr valign="top"> 
          <td width="18%"><font color="#CC3300" face="Verdana, Arial, Helvetica, sans-serif" size="2"> 
            <?echo"<img src=../photoimages/$image border=0 height=107 width=140>";?>
            </font></td>
          ...
          <td width="10%" align="center"><font face="Verdana, Arial, Helvetica, sans-serif" size="1" color="#CC3300"> 
            <?echo"<a href=photocategoryedit.php?catid=$catid><font color=#cc3300>Edit</font></a>";?>
            </font></td>
          <td width="11%" align="center"><font face="Verdana, Arial, Helvetica, sans-serif" size="1" color="#CC3300"> 
            <?echo"<a href=photocategorydel.php?del=$catid><font color=#cc3300>Delete</font></a>";?>
            </font> </td>
        </tr>
        <?
}
