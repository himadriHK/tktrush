...
<body>
 <form action="../upload.php?type=catedit&id=<?php echo $_GET['id'];?>" method="post" enctype="multipart/form-data" id="validate_category" >
          ...
          <td valign="top"><table width="100%" border="0" cellspacing="1" cellpadding="0">
            ...
            <table width="100%" border="0" cellspacing="1" cellpadding="3">
                ...
                <tr>
                  ...
                  <td bgcolor="#E9E9E9"><input type="text" name="name" class="required" value="<?php echo $category['name'];?>"/></td>
                </tr>
                 <tr>
                  <td bgcolor="#E9E9E9">Category Short Name</td>
                  <td bgcolor="#E9E9E9"><input type="text" name="ename" class="required" value="<?php echo $category['ename'];?>"/></td>
                </tr>
                <tr>
                  <td bgcolor="#E9E9E9">Category Description</td>
                  <td bgcolor="#E9E9E9"><input type="text" name="desc" value="<?php echo $category['desc'];?>"/></td>
                </tr>
                <tr>
                  <td bgcolor="#E9E9E9">Category Image</td>
                  <td bgcolor="#E9E9E9"><input type="file" name="fileToUpload" />
                  <img src="../upload/category/<?php echo $category['image']; ?>" />
                  </td>
                </tr>
                
                <tr>
                  <td bgcolor="#E9E9E9">&nbsp;</td>
                  <td bgcolor="#E9E9E9"><input type="submit" value="Update"/></td>
                </tr>
