...
if($save)
{
	...
	$result1 = mysql_query( "SELECT * FROM tblphoto where image='$image'");
	...
	//echo"Image Copied";
		...
		$query = "insert into tblphoto(catid,description,image)values('$category','$description','$userfile_name')";
		mysql_query($query);		
		echo"<font color=red size=4 face=verdana>Photo Added.</font>";	
		}

	else
		{
		echo"<font color=red size=4 face=verdana>Photo already exist.</font>";
		}
        ...
        <table width="70%" border="0" cellspacing="3" cellpadding="1" align="center">
          <tr>
            <td><table width="100%" border="1" cellspacing="0" cellpadding="1" align="center" bordercolor="#F3F3F3">
                ...
                <tr>
                  <td colspan="2" align="center" height="18"><font face="Verdana, Arial, Helvetica, sans-serif" size="1"><a href="viewphotocategory.php"><font color="#CC3300" size="2">View 
...
echo"<option value=$catid>$pcategory</option>";
          ...
          <tr align="center"> 
            <td colspan="2" valign="top"><font face="Verdana, Arial, Helvetica, sans-serif" size="2"><a href="viewphoto.php"><font color="#CC3300">View 
