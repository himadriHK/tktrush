      ...
      <form name="form1" enctype=multipart/form-data method="POST" action="<?php echo $editFormAction; ?>">
        <table width="100%" border="1" cellspacing="0" cellpadding="0" bordercolor="#F5F5F5">
          ...
          <tr align="center" valign="bottom"> 
            <td colspan="2" height="30"><font face="Verdana, Arial, Helvetica, sans-serif" size="2"><a href="view_countryrates.php"><font color="#CC3300">View 
              Country Rate </font></a></font></td>
          </tr>
        </table>
