...
<?php
     ...
     * @param  $action links
     * the post's action links (optional)
     ...
     * 
     * @param string $permissions_apikey Other application key
     * @param array $ (string) $method_arr
     * (Optional) API methods/namespaces
     * 
     * 
     * allowed
     * @return array API methods/namespaces which are allowed access
     ...
     * an array of strings describing the
     * 
     * 
     ...
     * user is a fan.
     * @param string $ type
     * limits results to a particular type of page.
     ...
     * (Optional) Restrict to an array of pids
     * 
     * 
     * (csv is deprecated)
     * 
     ...
     * @param int $ uid
     * (Optional) The user ID of the user whose photo you
     * 
     * 
     * are uploading
     ...
     * An array of user ids (csv is deprecated)
     ...
     * 
     * 'profiles'
     * => array of profile metadata of users/pages in posts
     * 
     * 
     * 'albums'
     * => array of album metadata in posts
     * 
     * 
