...
<html lang="en">
<head>
<title><?php echo $config['SITE_NAME']?> | Venues Management</title>
		...
		<div class="container-fluid">
			<div class="row-fluid ">
				<div class="span12">
					<div class="primary-head">
						<h3 class="page-header">Venues Management</h3>
						<ul class="top-right-toolbar">
							<li><a href="?f=1" class="green" title="Add Venue"><i class=" icon-plus-sign"></i></a></li>
							<li><a href="?f=3" class="bondi-blue" title="List Venues"><i class="icon-th-list"></i></a></li>
						</ul>
					</div>
				</div>
			</div>
                                        ...
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
                                                <select class="span4" id="category" name="category">
                                                    ...
                                                    <?php
                                                    $qry = "SELECT * FROM  tblvenuecategory ORDER BY category ASC";
            ...
            <?php
				...
				if(isset($_GET['searchFilter']) && ($_GET['searchFilter'] != "")) {
					$qry_str_search = " AND (tblvenue.catid = '".sqlSafe($_GET['searchFilter'])."')";
				...
				$count_qry = "SELECT COUNT(*) FROM tblvenue 
							  WHERE 1
							  ".$qry_str_search;
						
				$qry = "SELECT tblvenue.*, tblvenuecategory.category
						FROM tblvenue 
						LEFT JOIN tblvenuecategory ON tblvenue.catid = tblvenuecategory.catid
						WHERE 1
						".$qry_str_search."
						ORDER BY tblvenue.venueid DESC
						";
                              ...
                              <div class="dataTables_filter" id="data-table_filter">
                                <label>Venues:
                                  <select class="span4" id="searchFilter" name="searchFilter" onChange="form.submit()" style="width:250px;">
                                      ...
                                      <?php
                                      $qry2 = "SELECT * FROM tblvenuecategory ORDER BY category ASC";
                          ...
                          <table class="responsive table tbl-serach table-striped table-bordered dataTable" id="data-table">
							...
							?>
                              <tr>
                                ...
                                <td class="center"><img src="../venueimages/<?php echo $image?>" alt="N/A" width="100"></td>
            ...
            <?php
				...
				$count_qry = "SELECT COUNT(*) FROM  tblvenuecategory 
							  WHERE 1
							  ".$qry_str_search;
						
				$qry = "SELECT * FROM  tblvenuecategory 
						WHERE 1
						".$qry_str_search."
						ORDER BY catid DESC
						";
                          ...
                          <table class="responsive table tbl-serach table-striped table-bordered dataTable" id="data-table">
                            <thead>
                              <tr>
                              	<th><input name="allbox" type="checkbox" onclick="checkAllFields(1);" id="checkAll" /></th>
                                <th> Venue Name </th>
                                <th class="center"> Venue Image </th>
                                <th class="center"> Action </th>
                              </tr>
                            </thead>
                            <tbody>
				...
				if(($_FILES["image"]["name"] != "")){
					if($_FILES["image"]["type"] == "image/jpg" || $_FILES["image"]["type"] == "image/gif" || $_FILES["image"]["type"] == "image/jpeg" || $_FILES["image"]["type"] == "image/png") {
						if(($_FILES["image"]["size"] / 2048)  > 2048) {
							...
							move_uploaded_file($_FILES["image"]["tmp_name"],"../venueimages/$image_name");
						}
					}
					else {
			...
			case 4;
				deleteListItem($id, "tblvenue", "venueid");
				listRecords();
			break;
		
			case 5;
				$delAnn = isset($delAnn)?$delAnn:array();
				actionSelected($delAnn, "tblvenue", "venueid");
				listRecords();
			break;
			...
			case 7:
				...
				?>
					<div class="alert">
						<button data-dismiss="alert" class="close" type="button">×</button>
						<i class="icon-exclamation-sign"></i><strong>Warning!</strong> Venue "<?php echo $name?>" already exists.
					</div>
				<?php
					listCategoryRecords();
			...
			case 8;
				deleteListItem($id, "tblvenuecategory", "catid");
				listCategoryRecords();
			break;
		
			case 9;
				$delAnn = isset($delAnn)?$delAnn:array();
				actionSelected($delAnn, "tblvenuecategory", "catid");
				listCategoryRecords();
			break;
