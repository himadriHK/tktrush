...
if($_POST){
   ...
   $d=strtotime($date_end);
   $end1= date('Y-m-d',$d);

mysql_select_db($database_eventscon, $eventscon);
$query_eventRs = "SELECT events.*, promoters.name, promoters.phone  FROM events, promoters WHERE events.promoter = promoters.spid  AND country='$country' AND city='$city' AND date_start BETWEEN '$start' AND '$end1' ORDER BY hot ASC, ongoing DESC, tid DESC";	
...
//header("Location:$url/new_design/index.php");
mysql_select_db($database_eventscon, $eventscon);
...
<!--  <tr>
    ...
    <tr>
      ...
      <table style="width:538px;" border="0" cellspacing="1" cellpadding="0">
...
<?php
					...
					?>
<a href="javascript:"><img src="images/readmore_button.png" width="69" height="14" border="0" onclick="MM_openBrWindow('guests_details.php?eid=<?php echo $row_eventRs['tid']; ?>','guestdetails','toolbar=yes,location=yes,status=yes,menubar=yes,scrollbars=yes,resizable=yes,width=518,height=450')" /></a>		  </td>
          <td width="1"></td>
